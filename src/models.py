...
class EmotionModelTrainer:
    ...
    def train_xgboost(self, X_train: np.ndarray, y_train: np.ndarray, 
        ...
        if tune_hyperparams:
            ...
            # Create model
            base_model = xgb.XGBClassifier(random_state=self.model_config.get('random_state', 42), use_label_encoder=False, eval_metric='mlogloss')
            ...
            # Create model with default parameters
            model = xgb.XGBClassifier(n_estimators=100, random_state=self.model_config.get('random_state', 42), use_label_encoder=False, eval_metric='mlogloss')
